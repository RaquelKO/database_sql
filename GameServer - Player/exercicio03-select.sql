...
--1. Selecionar todas as informa��es da tabela Player
SELECT * FROM Player

--2. Selecionar todas as informa��es da tabela GameServer
...
--5. BETWEEN: Selecionar o IP, Type e CreationDate da tabela GameServer quando o ano de cria��o (CreationDate) estiver entre 2005 e 2018.
...
--7. AND: Selecionar o Name e o Password da tabela Player quando a idade (age) for 38 anos e o n�mero de pontos (points) for maior ou igual a 650.
...
--10. AND: Selecionar todas as informa��es da tabela GameServer quando os pontos (points) possu�rem valor (is not null) e o ano de cadastro (CreationDate) seja maior ou 2015.
