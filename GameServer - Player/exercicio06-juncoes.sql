...
--3. Criar uma consulta para exibir o IP de todos os GameSever e os Name dos respectivos Players quando existir associa��o.
SELECT 
	G.[IP] Endere�oIP,
	P.[Name] Nome
FROM
...
--7. Criar uma consulta para exibir o Type do GameServer e a m�dia de idade (Age) dos Players associados a eles.
SELECT 
	G.[Type] TipoServidor,
